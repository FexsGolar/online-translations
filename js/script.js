 ...
 $(document).ready(function() {
     ...
     function sendForm(formId) {
         ...
         if (window.location.href.includes('/en/')) { urlRedirect = 'https://mishkafilms.ru/en/thanks.html'; } else { urlRedirect = 'https://mishkafilms.ru/thanks.html'; }

         for (var i = 0; i <= (required.length - 1); i++) {
             if (required[i].value == '') { required[i].style.borderColor = 'rgba(255, 0, 0, 1)';
                 error = true; }
         }
         if (error) {
             return false;
